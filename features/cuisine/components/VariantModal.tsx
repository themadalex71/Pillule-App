                ...
                {!aliasToMove ? (
                    ...
                    <div className="flex items-center gap-3 mb-6 shrink-0 pr-8">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                <h3 className="font-bold text-xl text-[#4b3d6d] leading-tight">{editingMasterIngredient}</h3>
                                <button onClick={renameMasterIngredient} className="p-1.5 bg-[#f6f0eb] text-[#8d82a8] hover:text-[#4b3d6d] hover:bg-[#efe7de] rounded-full transition" title="Renommer l'ingrédient" >
                                    <Pencil size={12}/>
                                </button>
                            </div>
                                ...
                                {(aliases[editingMasterIngredient] || []).map(alias => (
                                    <div key={alias} className="flex items-center justify-between bg-white text-[#4b3d6d] text-sm px-3 py-3 rounded-lg border border-[#ece4f7] group hover:border-[#c9b8ea] transition">
                                        ...
                                        <div className="flex gap-1 shrink-0">
                                            ...
                                            <button onClick={() => removeAliasFromMaster(alias)} className="p-2 text-[#b9accf] hover:text-red-400 hover:bg-[#f6f0eb] rounded-lg transition" title="Détacher">
                                                <Trash2 size={16}/>
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div className="flex flex-col h-full overflow-hidden">
                        <div className="p-6 pb-2 shrink-0 bg-white z-10 shadow-xl border-b border-[#ece4f7]">
                            ...
                            <h3 className="font-bold text-lg text-[#4b3d6d] mb-1">Où déplacer &quot;{aliasToMove}&quot; ?</h3>
